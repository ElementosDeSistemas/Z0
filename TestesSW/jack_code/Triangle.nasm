...
incw %D
movw %D,(%A)
; Chamando função Main.drawTriangle
leaw $Main.drawTriangle.ret.1,%A
movw %A,%D
leaw $SP,%A
movw (%A),%A
movw %D,(%A)
...
leaw $LCL,%A
movw %D,(%A)
leaw $Main.drawTriangle,%A
jmp
Main.drawTriangle.ret.1:
; POP temp 0
leaw $SP,%A
movw (%A),%D
decw %D
...
movw (%A),%A
jmp
; Declarando função Main.drawTriangle
Main.drawTriangle:
leaw $0,%A
movw %A,%D
leaw $SP,%A
...
incw %D
movw %D,(%A)
; Chamando função Math.sqrt
leaw $Math.sqrt.ret.1,%A
movw %A,%D
leaw $SP,%A
movw (%A),%A
movw %D,(%A)

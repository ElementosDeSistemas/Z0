...
incw %D
movw %D,(%A)
; Chamando função Main.drawTrapezoid
leaw $Main.drawTrapezoid.ret.1,%A
movw %A,%D
leaw $SP,%A
movw (%A),%A
movw %D,(%A)
...
leaw $LCL,%A
movw %D,(%A)
leaw $Main.drawTrapezoid,%A
jmp
Main.drawTrapezoid.ret.1:
; POP temp 0
leaw $SP,%A
movw (%A),%D
decw %D
...
movw (%A),%A
jmp
; Declarando função Main.drawTrapezoid
Main.drawTrapezoid:
leaw $0,%A
movw %A,%D
leaw $SP,%A

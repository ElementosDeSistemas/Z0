...
incw %D
movw %D,(%A)
; Chamando função Main.drawParallelogram
leaw $Main.drawParallelogram.ret.1,%A
movw %A,%D
leaw $SP,%A
movw (%A),%A
movw %D,(%A)
...
leaw $LCL,%A
movw %D,(%A)
leaw $Main.drawParallelogram,%A
jmp
Main.drawParallelogram.ret.1:
; POP temp 0
leaw $SP,%A
movw (%A),%D
decw %D
...
movw (%A),%A
jmp
; Declarando função Main.drawParallelogram
Main.drawParallelogram:
; PUSH constant 0
leaw $0,%A
movw %A,%D
leaw $SP,%A
